<!-- Authors: Main Front End: Logan Ayer
	 ...
	 loginAdmin.php is the login form for admin to 4Rum-->
<html>
<head>
	<title> Admin Login to 4Rum </title>
	<style>
			...
			/* controls styling for the actual login form */
			#loginform {
			  position: absolute;
			  width: 300px;
			  height: 300px;
...
?>
	...
	<div id="header">
		<div id="headerlogo">
			<a href="../User/private.php"></a>
		</div>
		<ul>
			<li>
				<a href="../User/login.php" title="User Login">User Login</a> 
			</li>
			<li>
				<a href="../User/register.html" title="Register">Register</a> 
			</li>
			<li>
				<a href="AdminHome.html" title="Admin">Admin</a> 
			</li>
		</ul>
	</div>
